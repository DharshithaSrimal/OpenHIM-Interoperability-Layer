...
# START_DATE = "2022-06-30T00:00:00"
...
encounters = requests.get(
    f"{FHIR_SERVER_URL}/fhir/Encounter?_sort=date&_count=400000&date=ge{START_DATE}&date=le{END_DATE}&type=facility_visit,FOLLOWUP&_tag=PKT0010397&_tag:not=2.0.2-diabetesCompass",
    headers={"Authorization": f"Bearer {ACCESS_TOKEN}"}
)
